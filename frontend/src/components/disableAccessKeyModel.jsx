    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Warning Icon */}
                <div className="mb-4">
                    <WarningFilled className="text-[40px] text-[#F5A623] bg-[#FAF1CA] p-5 rounded-full" />
                </div>
                ...
                <p className="mb-8 text-[14px] leading-6 text-gray-500">
                    Disabling this Access key will impact dynamic workflows/pipes that
                    authenticated using it. Do you want to proceed?
                </p>
                ...
                <div className="flex justify-center gap-4">
                    ...
                    <Button
                        ...
                        className="text-sm rounded-lg bg-[#ECA231] font-medium hover:!bg-[#E59416]"
                    >
                        Disable Now
                    </Button>
                </div>
...
export default DisableAccessKeyModal;
